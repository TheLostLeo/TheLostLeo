<div align="center">
  ...
  <p align="center">
    I design reliable backend systems, Linux infrastructure, containerized deployments, and autonomous robotics platforms.<br/>
    Passionate about automated workflows, low-latency control, and low-level system design.
  </p>
...
- 🤖 **Autonomous Systems & Robotics:** Sensor fusion, ROS nodes, path planning, and embedded control
- 🐳 **DevOps & Infrastructure:** Dockerized environments, self-hosted Linux stacks, CI/CD, and network automation
- ⚡ **Scalable Backends:** High-performance APIs, relational database design, and real-time event streaming
